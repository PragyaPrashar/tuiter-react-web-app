export default[
    ...
    {
        avatarIcon:'../bookmarks/newyorkpost_icon.png',
        userName:'NewYorkPost',
        handle:'@nypost',
        time:'23h',
        taglineWithOutLink:'Grimes seen reading Karl Marx following split with world\'s richest man Elon Musk',
        taglineWithLink:'trib.ai/nx2Gfag',
        taglineWithNoLink:'',
        image:'../bookmarks/body2_thumbnail.jpg',
        caption:'Countdown inspiration4 Mission to Space| Netflix Official Site ',
        text:'From training to launch to landing, this all-access docuseries rides along with the Inspiration4 crew on the first all-civilian orbital space...',
        redirect:'netflix.com',
        comment:'4.2K',
